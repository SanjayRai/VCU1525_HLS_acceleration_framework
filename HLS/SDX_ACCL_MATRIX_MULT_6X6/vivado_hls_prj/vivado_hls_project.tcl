...
add_files -tb ../src/tb_matrix_mult_6x6.cpp -cflags "-O3 -std=c++0x -DVHLS_FLOW -DGPP_ONLY_FLOW $INCLUDES -I$XILINX_OPENCL/runtime/include/1_2 -I$XILINX_VIVADO/include -L$XILINX_OPENCL/runtime/lib/x86_64 -lrt"
